...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        VennDiagram<Integer> numberDiagram = new VennDiagram<>(evens, prime, fibonnacis);

        numberDiagram.add(1, fibonnacis, prime);
        numberDiagram.add(2, evens, prime, fibonnacis);
        numberDiagram.add(3, prime, fibonnacis);
        numberDiagram.add(4, evens);
        numberDiagram.add(5, prime, fibonnacis);
        ...
        // prime OR even
        System.out.println(numberDiagram.unionOf(prime, evens));
        // even AND fibonnacis
        System.out.println(numberDiagram.intersectionOf(evens, fibonnacis));
        // fibonnacis but NOT prime
        System.out.println(numberDiagram.complementOf(fibonnacis, prime));
        // all three
